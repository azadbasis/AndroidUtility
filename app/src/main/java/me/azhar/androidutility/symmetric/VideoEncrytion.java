package me.azhar.androidutility.symmetric;
...
public class VideoEncrytion {
    ...
    public static void decrypt(SecretKey key, AlgorithmParameterSpec paramSpec, InputStream in, OutputStream out)
        ...
        try {
            ...
            out.close();
            ///sdcard/Movies/Bangla Cartoon Meena - Porir Golpo(1).mp4
            ///sdcard/Movies/meena.mp4
        }
    }
   ...
   /* public static void main(String[] args) {
     *//*   File inFile = new File("C:/enc_test/video.swf");
        ...
        File inFile = new File("/sdcard/Movies/meena.mp4");
        File outFile = new File("/sdcard/Movies/meena_enc.mp4");
        File outFile_dec = new File("/sdcard/Movies/meena_dec.mp4");
